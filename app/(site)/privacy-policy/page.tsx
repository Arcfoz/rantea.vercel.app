...
export default function page() {
  return (
    <div className="m-auto flex w-full max-w-screen-xl flex-col px-6 py-12 md:px-16 2xl:px-32 2xl:py-16 ">
      <div style={{ textAlign: "center" }}>
        <h1 className="text-3xl font-bold mb-12">Rantea App Privacy Policy</h1>
      </div>
      <>
        <strong className="text-xl">Privacy Policy</strong>
        <p>
          This privacy policy applies to the Rantea app (hereby referred to as &quot;Application&quot;) for mobile devices that was created by Rantea Capstone Project Team (hereby referred to as &quot;Service Provider&quot;) as a Free
          service. This service is intended for use &quot;AS IS&quot;.
        </p>
        <br />
        <strong className="text-xl">Information Collection and Use</strong>
        ...
        <br />
        <p>
          For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information. The information that the Service Provider request will be retained by them
          and used as described in this privacy policy.
        </p>
        <br />
        <strong className="text-xl">Third Party Access</strong>
        <p>
        ...
        <p />
        <br />
        <strong className="text-xl">Opt-Out Rights</strong>
        <p>
        ...
        <br />
        <strong className="text-xl">Data Retention Policy</strong>
        <p>
          ...
          please contact them at rantea.research@gmail.com and they will respond in a reasonable time.
        </p>
        <br />
        ...
        <div>
          <br />
          <p>
            The Application does not address anyone under the age of 13. The Service Provider does not knowingly collect personally identifiable information from children under 13 years of age. In the case the Service Provider discover that
            a child under 13 has provided personal information, the Service Provider will immediately delete this from their servers. If you are a parent or guardian and you are aware that your child has provided us with personal
            information, please contact the Service Provider (rantea.research@gmail.com) so that they will be able to take the necessary actions.
          </p>
        </div>
        <br />
        <strong className="text-xl">Security</strong>
        <p>
          The Service Provider is concerned about safeguarding the confidentiality of your information. The Service Provider provides physical, electronic, and procedural safeguards to protect information the Service Provider processes and
          maintains.
        </p>
        <br />
        <strong className="text-xl">Changes</strong>
        <p>
          This Privacy Policy may be updated from time to time for any reason. The Service Provider will notify you of any changes to the Privacy Policy by updating this page with the new Privacy Policy. You are advised to consult this
          Privacy Policy regularly for any changes, as continued use is deemed approval of all changes.
        </p>
        <br />
        <p>This privacy policy is effective as of 2024-04-01</p>
        <br />
        <strong className="text-xl">Your Consent</strong>
        ...
        <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at rantea.research@gmail.com.</p>
